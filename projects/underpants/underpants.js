...
_.partition = function(array, callback){
   ...
   let result = [];
    ...
    result.push(truthyArray, falsyArray);
    return result;
};
...
_.partition = function(array, callback){
return _.filter(array, function(e, i, a){
    return ([!callback(e, i, a)]).concat([callback(e, i, a)]);
    });
};
*/
...
/*
_.pluck = function(array, property){
    return _.filter(array, function(object[key], key, object) {
        if(key === property){
...
_.some = function(collection, callback){
    if(callback === undefined) {
        ...
        if(_.filter(collection, callback(e, i, a).length > 0)) {
...
/*
use !every?
use .filter if .length > 0 result = true, return result?
*/
...
_.extend = function(obj) {
    _.each(arguments, function(args, i, a) {
       for (var key in args)
            obj[key] = args[key];
    });
    return obj;
...
/*
    let updatedObject;
    _.each(arguments, function(e, i, a){
        updatedObject = Object.create(arguments); 
    });
    return updatedObject;
};
*/
